...
MACRO_ALLOC_POOL_ID_IMPL(CBossSlime, MAX_CLIENTS * ENGINE_MAX_MAPS + MAX_CLIENTS)
...
void CBossSlime::Tick()
{
	TickBotAI();
	CCharacter::Tick();
}

bool CBossSlime::TakeDamage(vec2 Force, int Dmg, int From, int Weapon)
{
